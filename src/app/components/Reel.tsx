  ...
  return (
    <section id="reel" ref={ref} className="py-24 px-6">
      <div className="max-w-[1440px] mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-5xl mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
            Motion Reel
          </h2>
        ...
        <motion.div
          ...
          className="relative aspect-video bg-card rounded overflow-hidden group cursor-pointer"
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-background to-transparent">
            <p className="text-sm text-muted-foreground">Click to play showreel</p>
          </div>
        </motion.div>
      </div>
    </section>
